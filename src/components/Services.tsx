...
export default function Services() {
  ...
  return (
    <section
      id="servicios"
      ref={ref}
      className="relative w-full bg-[color:var(--warm-white)] py-24 lg:py-40"
    >
      <div className="max-w-7xl mx-auto px-6 sm:px-10 lg:px-16">
        ...
        <div className="text-center mb-16 lg:mb-20">
          ...
          <motion.h2
            ...
            animate={inView ? "show" : "hidden"}
            custom={1}
            className="text-[color:var(--text-primary)] leading-[1.1] mb-8 mx-auto"
            style={{
          ...
          {services.map((service, i) => {
            ...
            return (
              <motion.article
                ...
                animate={inView ? "show" : "hidden"}
                custom={i}
                className="group relative bg-white rounded-xl p-10 shadow-[0_2px_20px_rgba(0,0,0,0.04)] transition-all duration-300 ease-out hover:-translate-y-1 hover:shadow-[0_20px_50px_-15px_rgba(26,42,74,0.18)] overflow-hidden"
              >
                {/* Top gradient line */}
                <span
                  aria-hidden
                ...
                {/* Icon */}
                <div className="w-14 h-14 rounded-full bg-[color:var(--cream)] flex items-center justify-center mb-6 transition-colors duration-300 group-hover:bg-[color:var(--accent)]/10">
                  <Icon
                    size={24}
                ...
                <h3
                  className="text-[18px] text-[color:var(--text-primary)] mb-3"
                  style={{
                ...
                <p
                  className="text-[color:var(--text-secondary)] text-[14.5px]"
